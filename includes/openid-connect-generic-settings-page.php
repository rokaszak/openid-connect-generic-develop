...
class OpenID_Connect_Generic_Settings_Page {
	...
	private function get_settings_fields() {
		...
		$fields = array(
			...
			'discovery_url'    => array(
				'title'       => __( 'Discovery URL', 'daggerhart-openid-connect-generic' ),
				'description' => __( 'OpenID Connect discovery endpoint. All other endpoints (authorize, token, userinfo, logout) are resolved automatically from this URL.', 'daggerhart-openid-connect-generic' ),
				'example'     => 'https://example.com/.well-known/openid-configuration',
				'type'        => 'text',
				'disabled'    => defined( 'OIDC_DISCOVERY_URL' ),
				'section'     => 'client_settings',
			),
			'failure_redirect_url' => array(
				'title'       => __( 'IDP Failure Redirect URL', 'daggerhart-openid-connect-generic' ),
				'description' => __( 'Where to redirect users when the identity provider is unreachable (e.g. a status page). Login buttons will point here instead of the IDP.', 'daggerhart-openid-connect-generic' ),
